<template>
  <div class="reg-key">
    <div class="header-actions">
      ...
      <Icon class="icon" icon="lucide:broom" width="22" height="22" @click="clearNotUse"/>
    </div>
          ...
          <div class="code-info">
            ...
            <div class="info-right">
              <el-dropdown class="setting">
                <Icon icon="lucide:settings" width="21" height="21" color="#909399"/>
                <template #dropdown>
                  <el-dropdown-menu>
    ...
    <el-dialog v-model="showAdd" :title="$t('addRegKey')">
      <div class="container">
        <el-input v-model="addForm.code" :placeholder="$t('regKey')" @keyup.enter="submit">
          <template #suffix>
            <Icon @click.stop="genCode" class="gen-code" icon="lucide:refresh-cw" width="24" height="24"/>
          </template>
        </el-input>
